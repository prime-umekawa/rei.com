...
import { usePartnerContactForm } from '@/hooks/contact/usePartnerContactForm';

const PartnerContactForm = (): JSX.Element => {
  const { control, handleClickSubmit } = usePartnerContactForm();
